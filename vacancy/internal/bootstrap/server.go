...
import (
	...
	"github.com/artem13815/hr/vacancy/internal/pb/auth_api"
...
func AppRun(api *transport_grpc.VacancyServiceAPI, authClient auth_api.AuthServiceClient, cfg *config.Config, onShutdown ...func()) error {
