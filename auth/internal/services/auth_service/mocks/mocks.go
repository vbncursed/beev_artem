...
func (_mock *AuthStorage) GetUserByEmail(ctx context.Context, email string) (*domain.User, error) {
...
func (_c *AuthStorage_GetUserByEmail_Call) Return(user *domain.User, err error) *AuthStorage_GetUserByEmail_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *AuthStorage_GetUserByEmail_Call) RunAndReturn(run func(ctx context.Context, email string) (*domain.User, error)) *AuthStorage_GetUserByEmail_Call {
	_c.Call.Return(run)
	return _c
}

// GetUserByID provides a mock function for the type AuthStorage
func (_mock *AuthStorage) GetUserByID(ctx context.Context, userID uint64) (*domain.User, error) {
	...
	var r0 *domain.User
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uint64) (*domain.User, error)); ok {
		return returnFunc(ctx, userID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uint64) *domain.User); ok {
...
func (_c *AuthStorage_GetUserByID_Call) Return(user *domain.User, err error) *AuthStorage_GetUserByID_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *AuthStorage_GetUserByID_Call) RunAndReturn(run func(ctx context.Context, userID uint64) (*domain.User, error)) *AuthStorage_GetUserByID_Call {
	_c.Call.Return(run)
	return _c
}
